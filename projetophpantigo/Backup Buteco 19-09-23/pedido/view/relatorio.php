    ...
    <div class="col-sm-8 text-left">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel"><b>Itens do Pedido</b></h5>
      ...
      <table id="pedidos" class="table table-hover table-bordered table-responsive" >
       ...
       <tbody>
          ...
          <?php
           ...
           if($_SESSION['id_perfil'] == '1'){
            ...
            foreach ($x as $key) {
              ...
              echo "<td> <a class='btn btn-success btn-sm' href='../control/pedido.php?v1=".$key['id_pedido']."'>Visualizar</a> ";

              if($_SESSION['id_perfil'] == '1' AND $key['Status'] == 'CONFIRMADO'){
                echo "<a class='btn btn btn-warning btn-sm' href='../control/pedido.php?v5=".$key['id_pedido']."'>Voltar Status</a> ";;                
                echo "<a class='btn btn-danger btn-sm' href='../control/pedido.php?deletar=".$key['id_pedido']."'>Excluir</a></td>";
              }
              echo "</tr>";
              //echo "</tr>";
              if($key['Status'] != 'EXCLUIDO'){
                $total += $key['Total'];
              }
            }
            echo "<td hidden></td>";
         ...
         <p> Total Pedidos: R$ <?php echo number_format($total,2,',','.'); ?></p>
