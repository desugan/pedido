  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#"><span class="glyphicon glyphicon-user"></span> &nbsp; <?php if(isset($_SESSION['usuario'])){ echo $_SESSION['usuario'];$usu =(int)$_SESSION['id_cliente']; } ?></a></li>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      <h1 align="center">Meus Pedidos Pendentes</h1>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <?php
                if(isset($_SESSION['visualizar'])){
                  ...
                  foreach ($itens as $item) {
                    ...
                    echo "<td>".$item[1]."</td>";
                    echo "<td>".$item[2]."</td>";
                    echo "<td>R$ ".number_format($item[3],2,',','.')."</td>";
                    echo "<td>R$ ".number_format($item[4],2,',','.')."</td></tr>";  
                    $valor += $item[4];
                    $total = $valor;                 
                  }
                }
            ...
            <div class="modal-footer">
                <h5 align="left"><b>ID Pedido:</b> <?php if(isset($id_pedido)){echo $id_pedido;}?></h5>
                <h5 align="left"><b>Total:</b> R$ <?php if(isset($total)){echo number_format($total,2,',','.');}?></h5>
          ...
          <?php
            ...
            foreach ($x as $key) {
              ...
              if($key['Status'] == 'CONFIRMADO'){
                ...
                echo "<td> <a class='btn btn-success btn-sm' href='../control/pedido.php?v2=".$key['id_pedido']."'>Visualizar</a> ";
                if($_SESSION['id_perfil'] == '1' AND $key['Status'] == 'CONFIRMADO'){
                  echo "<a class='btn btn btn-warning btn-sm' href='../control/pedido.php?v6=".$key['id_pedido']."'>Voltar Status</a> ";;                
                  echo "<a class='btn btn-danger btn-sm' href='../control/pedido.php?v7=".$key['id_pedido']."'>Excluir</a></td>";
                }                
                echo "</tr>";
                $total += $key['Total'];
              }
        ...
        if ($msg == 1) {
            ...
            echo "
                <div class='alert alert-warning alert-dismissible' id='myAlert'>
                  <a href='#' class='close'>&times;</a>
                  <span class='glyphicon glyphicon-thumbs-up fa-2x'></span>
                  <h6><strong>Atenção,</strong> pedido voltou para confirmação!</h6>                                 
                </div>";
        }
        elseif($msg==5){
            echo "
