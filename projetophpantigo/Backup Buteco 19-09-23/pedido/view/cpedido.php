...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      <h1 align="center">Confirmar Pedidos</h1>
              ...
              <?php
                ...
                if(isset($_SESSION['pedidos'])){
                  ...
                  foreach ($itens as $key => $item) {
                    ...
                    echo "<td>".$item[4]."</td>";                 
                    //echo "<td><a href='../control/cadPagamento.php?confirmar='".$key."'>Confirmar</a>";
                    echo "<td><a class='btn btn-primary btn-sm' href='../control/pedido.php?v3=".$item[0]."'>Visualizar</a> ";
                    echo "<a class='btn btn-success btn-sm' href='../control/pedido.php?v3=".$item[0]."'>Confirmar</a> ";
                    echo "<a class='btn btn-danger btn-sm' href='../control/pedido.php?v3=".$item[0]."'>Rejeitar</a></td>";
...
<script>
  ...
  <?php if($msg == 3){    echo "$('#myModal1').modal('show');";  } ?>
