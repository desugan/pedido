...
/**
 * Página de visualização de pedidos do usuário logado.
 * @returns {JSX.Element} Página de meus pedidos.
 */
const MeusPedidos: React.FC = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const result = await pedidoService.getPedidosByClienteId(user.id_cliente, 1, 10000);
